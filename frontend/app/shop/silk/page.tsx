...
const subCategories = [
  { title: "Banarasi Silk", img: "/banarasi.jpg", type: "banarasi" },
  { title: "Kanjivaram Silk", img: "/kanjivaram.jpg", type: "kanjivaram" },
  { title: "Tussar Silk", img: "/tussar.jpg", type: "tussar" },
  { title: "Paithani Silk", img: "/paithani.jpg", type: "paithani" },
];

export default function SilkPage() {
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      <h1 className="text-4xl font-bold text-center mb-4 text-amber-900">Silk Sarees</h1>
      <p className="text-center text-lg text-gray-700 mb-12 max-w-3xl mx-auto">
        Luxurious silk sarees with rich weaves and royal charm
      </p>
